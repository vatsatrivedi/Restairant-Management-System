...
<div id="top">
    <table align="center" bgcolor="red">
        ...
        <form action="{{url('orderconfirm')}}" methdo="POST">
            @csrf             
    ...
    <button id="order" type="button" class="btn btn-outline-primary">Order Now</button>
    ...
    <div id="appear" align="center" style="padding: 10px; display: none;" >
        <div style="padding: 10px;">
            ...
            <button type="submit" class="btn btn-outline-success">Order Confirm</button>
            <button type="button" class="btn btn-outline-danger" id="close">Close</button>
            <div>
